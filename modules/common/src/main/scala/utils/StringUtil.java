...
public class StringUtil {
    ...
    public static Boolean compareMatch(String regex, String originString) {
        Pattern pattern = Pattern.compile("(\\b"+regex+"\\b)+", Pattern.CASE_INSENSITIVE);
        return pattern.matcher(originString).matches();
    }
...
//			System.out.println(str);
    ...
    public static String removeXMLTag(String xml, int offset) {
        String modifiedXML = "";
        String[] travels = xml.split("\n");
        String[] travelsCopy = java.util.Arrays.copyOfRange(travels, offset, travels.length - 2);
    ...
    public static void main(String[] args) {
        System.out.println(StringUtil.toTitleCase("welcome nigeria"));
    }
}