...
public interface EnhancedAirBookPortType {
    ...
    @WebResult(name = "EnhancedAirBookRS", targetNamespace = "http://flight.services.sabre.com/sp/eab/v3_2", partName = "body")
    public EnhancedAirBookRS enhancedAirBookRQ(
            ...
            @WebParam(name = "EnhancedAirBookRQ", targetNamespace = "http://flight.services.sabre.com/sp/eab/v3_2", partName = "body")
