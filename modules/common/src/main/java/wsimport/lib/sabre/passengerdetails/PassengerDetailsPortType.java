...
public interface PassengerDetailsPortType {
    ...
    @WebResult(name = "PassengerDetailsRS", targetNamespace = "http://flight.services.sabre.com/sp/pd/v3_2", partName = "body")
    public PassengerDetailsRS passengerDetailsRQ(
            ...
            @WebParam(name = "PassengerDetailsRQ", targetNamespace = "http://flight.services.sabre.com/sp/pd/v3_2", partName = "body")
