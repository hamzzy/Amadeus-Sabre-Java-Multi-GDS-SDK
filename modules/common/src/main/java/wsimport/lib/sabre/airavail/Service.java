 ...
 *       &lt;attribute name="operation_manager" type="{http://services.sabre.com/STL_Header/v120}Text.Short" />
...
@XmlType(name = "Service", namespace = "http://flight.services.service.sabre.com/STL_Header/v120", propOrder = {
    "value"
})
public class Service {
    ...
    @XmlAttribute(name = "operation_manager")
    ...
    /**
     * Gets the value of the operation_manager property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the operation_manager property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
