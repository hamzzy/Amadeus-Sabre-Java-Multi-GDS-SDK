...
@XmlRootElement(name = "GetPNR")
public class GetPNR {

    @XmlElement(name = "OTA_ReadRQ")
    protected GetPNR.OTAReadRQ otaReadRQ;
     ...
     * @return
     *     possible object is
     *     {@link GetPNR.OTAReadRQ }
     *     
     */
    public GetPNR.OTAReadRQ getOTAReadRQ() {
        return otaReadRQ;
    }
     ...
     *     
     */
    public void setOTAReadRQ(GetPNR.OTAReadRQ value) {
    ...
    public static class OTAReadRQ {
        ...
        protected GetPNR.OTAReadRQ.ReadRequests readRequests;
         ...
         * @return
         *     possible object is
         *     {@link GetPNR.OTAReadRQ.ReadRequests }
         *     
         */
        public GetPNR.OTAReadRQ.ReadRequests getReadRequests() {
            return readRequests;
        }
         ...
         *     
         */
        public void setReadRequests(GetPNR.OTAReadRQ.ReadRequests value) {
        ...
        public static class ReadRequests {
            ...
            @XmlElements({
                @XmlElement(name = "HotelReadRequest", type = GetPNR.OTAReadRQ.ReadRequests.HotelReadRequest.class),
                @XmlElement(name = "VehicleReadRequest", type = GetPNR.OTAReadRQ.ReadRequests.VehicleReadRequest.class),
                @XmlElement(name = "AirReadRequest", type = GetPNR.OTAReadRQ.ReadRequests.AirReadRequest.class),
                @XmlElement(name = "GolfReadRequest", type = GetPNR.OTAReadRQ.ReadRequests.GolfReadRequest.class),
                @XmlElement(name = "PkgReadRequest", type = GetPNR.OTAReadRQ.ReadRequests.PkgReadRequest.class),
                @XmlElement(name = "ReadRequest", type = GetPNR.OTAReadRQ.ReadRequests.ReadRequest.class),
                @XmlElement(name = "CruiseReadRequest", type = GetPNR.OTAReadRQ.ReadRequests.CruiseReadRequest.class),
                @XmlElement(name = "GlobalReservationReadRequest", type = GetPNR.OTAReadRQ.ReadRequests.GlobalReservationReadRequest.class)
            })
             ...
             * {@link GetPNR.OTAReadRQ.ReadRequests.HotelReadRequest }
             * {@link GetPNR.OTAReadRQ.ReadRequests.VehicleReadRequest }
             * {@link GetPNR.OTAReadRQ.ReadRequests.AirReadRequest }
             * {@link GetPNR.OTAReadRQ.ReadRequests.GolfReadRequest }
             * {@link GetPNR.OTAReadRQ.ReadRequests.PkgReadRequest }
             * {@link GetPNR.OTAReadRQ.ReadRequests.ReadRequest }
             * {@link GetPNR.OTAReadRQ.ReadRequests.CruiseReadRequest }
             * {@link GetPNR.OTAReadRQ.ReadRequests.GlobalReservationReadRequest }
             * 
             * 
             */
            ...
            public static class AirReadRequest {
                ...
                protected GetPNR.OTAReadRQ.ReadRequests.AirReadRequest.Telephone telephone;
                @XmlElement(name = "CustLoyalty")
                protected GetPNR.OTAReadRQ.ReadRequests.AirReadRequest.CustLoyalty custLoyalty;
                ...
                protected GetPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo queueInfo;
                 ...
                 * @return
                 *     possible object is
                 *     {@link GetPNR.OTAReadRQ.ReadRequests.AirReadRequest.Telephone }
                 *     
                 */
                public GetPNR.OTAReadRQ.ReadRequests.AirReadRequest.Telephone getTelephone() {
                    return telephone;
                }
                 ...
                 *     
                 */
                public void setTelephone(GetPNR.OTAReadRQ.ReadRequests.AirReadRequest.Telephone value) {
                 ...
                 * @return
                 *     possible object is
                 *     {@link GetPNR.OTAReadRQ.ReadRequests.AirReadRequest.CustLoyalty }
                 *     
                 */
                public GetPNR.OTAReadRQ.ReadRequests.AirReadRequest.CustLoyalty getCustLoyalty() {
                    return custLoyalty;
                }
                 ...
                 *     
                 */
                public void setCustLoyalty(GetPNR.OTAReadRQ.ReadRequests.AirReadRequest.CustLoyalty value) {
                 ...
                 * @return
                 *     possible object is
                 *     {@link GetPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo }
                 *     
                 */
                public GetPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo getQueueInfo() {
                    return queueInfo;
                }
                 ...
                 *     
                 */
                public void setQueueInfo(GetPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo value) {
                ...
                public static class QueueInfo {
                    ...
                    protected List<GetPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo.Queue> queue;
                     ...
                     * <p>
                     * Objects of the following type(s) are allowed in the list
                     * {@link GetPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo.Queue }
                     * 
                     * 
                     */
                    public List<GetPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo.Queue> getQueue() {
                        if (queue == null) {
                            queue = new ArrayList<GetPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo.Queue>();
                        }
                        return this.queue;
                    }
            ...
            public static class CruiseReadRequest {
                ...
                protected GetPNR.OTAReadRQ.ReadRequests.CruiseReadRequest.SelectedSailing selectedSailing;
                 ...
                 * @return
                 *     possible object is
                 *     {@link GetPNR.OTAReadRQ.ReadRequests.CruiseReadRequest.SelectedSailing }
                 *     
                 */
                public GetPNR.OTAReadRQ.ReadRequests.CruiseReadRequest.SelectedSailing getSelectedSailing() {
                 ...
                 *     
                 */
                public void setSelectedSailing(GetPNR.OTAReadRQ.ReadRequests.CruiseReadRequest.SelectedSailing value) {
            ...
            public static class GolfReadRequest {
                ...
                protected List<GetPNR.OTAReadRQ.ReadRequests.GolfReadRequest.Membership> membership;
                @XmlElement(name = "Name")
                protected PersonNameType name;
                 ...
                 * <p>
                 * Objects of the following type(s) are allowed in the list
                 * {@link GetPNR.OTAReadRQ.ReadRequests.GolfReadRequest.Membership }
                 * 
                 * 
                 */
                public List<GetPNR.OTAReadRQ.ReadRequests.GolfReadRequest.Membership> getMembership() {
                    if (membership == null) {
                        membership = new ArrayList<GetPNR.OTAReadRQ.ReadRequests.GolfReadRequest.Membership>();
                    }
            ...
            public static class HotelReadRequest {
                ...
                protected GetPNR.OTAReadRQ.ReadRequests.HotelReadRequest.Airport airport;
                @XmlElement(name = "UserID")
                protected GetPNR.OTAReadRQ.ReadRequests.HotelReadRequest.UserID userID;
                 ...
                 * @return
                 *     possible object is
                 *     {@link GetPNR.OTAReadRQ.ReadRequests.HotelReadRequest.Airport }
                 *     
                 */
                public GetPNR.OTAReadRQ.ReadRequests.HotelReadRequest.Airport getAirport() {
                    return airport;
                }
                 ...
                 *     
                 */
                public void setAirport(GetPNR.OTAReadRQ.ReadRequests.HotelReadRequest.Airport value) {
                    this.airport = value;
                }
                 ...
                 * @return
                 *     possible object is
                 *     {@link GetPNR.OTAReadRQ.ReadRequests.HotelReadRequest.UserID }
                 *     
                 */
                public GetPNR.OTAReadRQ.ReadRequests.HotelReadRequest.UserID getUserID() {
                    return userID;
                }
                 ...
                 *     
                 */
                public void setUserID(GetPNR.OTAReadRQ.ReadRequests.HotelReadRequest.UserID value) {
                    this.userID = value;
                }
