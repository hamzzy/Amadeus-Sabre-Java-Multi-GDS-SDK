...
@XmlRootElement(name = "BookFlightWithRecommendationResponse")
public class BookFlightWithRecommendationResponse {

    @XmlElement(name = "OTA_AirBookRS")
    protected BookFlightWithRecommendationResponse.OTAAirBookRS otaAirBookRS;
     ...
     * @return
     *     possible object is
     *     {@link BookFlightWithRecommendationResponse.OTAAirBookRS }
     *     
     */
    public BookFlightWithRecommendationResponse.OTAAirBookRS getOTAAirBookRS() {
        return otaAirBookRS;
    }
     ...
     *     
     */
    public void setOTAAirBookRS(BookFlightWithRecommendationResponse.OTAAirBookRS value) {
    ...
    public static class OTAAirBookRS {
        ...
        protected BookFlightWithRecommendationResponse.OTAAirBookRS.AirReservation airReservation;
        @XmlElements({
         ...
         * @return
         *     possible object is
         *     {@link BookFlightWithRecommendationResponse.OTAAirBookRS.AirReservation }
         *     
         */
        public BookFlightWithRecommendationResponse.OTAAirBookRS.AirReservation getAirReservation() {
         ...
         *     
         */
        public void setAirReservation(BookFlightWithRecommendationResponse.OTAAirBookRS.AirReservation value) {
