 ...
 *       &lt;sequence>
 *         &lt;element name="CoveragePref" type="{http://epowerv5.amadeus.com.tr/WS}VehicleAvailRQAdditionalInfoTypeCoveragePref" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfVehicleAvailRQAdditionalInfoTypeCoveragePref {
    ...
    protected List<VehicleAvailRQAdditionalInfoTypeCoveragePref> coveragePref;
     ...
     * {@link VehicleAvailRQAdditionalInfoTypeCoveragePref }
     * 
     * 
     */
    public List<VehicleAvailRQAdditionalInfoTypeCoveragePref> getCoveragePref() {
        if (coveragePref == null) {
            coveragePref = new ArrayList<VehicleAvailRQAdditionalInfoTypeCoveragePref>();
        }
