...
@XmlRootElement(name = "GetCarPNR")
public class GetCarPNR {

    @XmlElement(name = "OTA_ReadRQ")
    protected GetCarPNR.OTAReadRQ otaReadRQ;
     ...
     * @return
     *     possible object is
     *     {@link GetCarPNR.OTAReadRQ }
     *     
     */
    public GetCarPNR.OTAReadRQ getOTAReadRQ() {
        return otaReadRQ;
    }
     ...
     *     
     */
    public void setOTAReadRQ(GetCarPNR.OTAReadRQ value) {
    ...
    public static class OTAReadRQ {
        ...
        protected GetCarPNR.OTAReadRQ.ReadRequests readRequests;
         ...
         * @return
         *     possible object is
         *     {@link GetCarPNR.OTAReadRQ.ReadRequests }
         *     
         */
        public GetCarPNR.OTAReadRQ.ReadRequests getReadRequests() {
            return readRequests;
        }
         ...
         *     
         */
        public void setReadRequests(GetCarPNR.OTAReadRQ.ReadRequests value) {
        ...
        public static class ReadRequests {
            ...
            @XmlElements({
                @XmlElement(name = "HotelReadRequest", type = GetCarPNR.OTAReadRQ.ReadRequests.HotelReadRequest.class),
                @XmlElement(name = "VehicleReadRequest", type = GetCarPNR.OTAReadRQ.ReadRequests.VehicleReadRequest.class),
                @XmlElement(name = "AirReadRequest", type = GetCarPNR.OTAReadRQ.ReadRequests.AirReadRequest.class),
                @XmlElement(name = "GolfReadRequest", type = GetCarPNR.OTAReadRQ.ReadRequests.GolfReadRequest.class),
                @XmlElement(name = "PkgReadRequest", type = GetCarPNR.OTAReadRQ.ReadRequests.PkgReadRequest.class),
                @XmlElement(name = "ReadRequest", type = GetCarPNR.OTAReadRQ.ReadRequests.ReadRequest.class),
                @XmlElement(name = "CruiseReadRequest", type = GetCarPNR.OTAReadRQ.ReadRequests.CruiseReadRequest.class),
                @XmlElement(name = "GlobalReservationReadRequest", type = GetCarPNR.OTAReadRQ.ReadRequests.GlobalReservationReadRequest.class)
            })
             ...
             * {@link GetCarPNR.OTAReadRQ.ReadRequests.HotelReadRequest }
             * {@link GetCarPNR.OTAReadRQ.ReadRequests.VehicleReadRequest }
             * {@link GetCarPNR.OTAReadRQ.ReadRequests.AirReadRequest }
             * {@link GetCarPNR.OTAReadRQ.ReadRequests.GolfReadRequest }
             * {@link GetCarPNR.OTAReadRQ.ReadRequests.PkgReadRequest }
             * {@link GetCarPNR.OTAReadRQ.ReadRequests.ReadRequest }
             * {@link GetCarPNR.OTAReadRQ.ReadRequests.CruiseReadRequest }
             * {@link GetCarPNR.OTAReadRQ.ReadRequests.GlobalReservationReadRequest }
             * 
             * 
             */
            ...
            public static class AirReadRequest {
                ...
                protected GetCarPNR.OTAReadRQ.ReadRequests.AirReadRequest.Telephone telephone;
                @XmlElement(name = "CustLoyalty")
                protected GetCarPNR.OTAReadRQ.ReadRequests.AirReadRequest.CustLoyalty custLoyalty;
                ...
                protected GetCarPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo queueInfo;
                 ...
                 * @return
                 *     possible object is
                 *     {@link GetCarPNR.OTAReadRQ.ReadRequests.AirReadRequest.Telephone }
                 *     
                 */
                public GetCarPNR.OTAReadRQ.ReadRequests.AirReadRequest.Telephone getTelephone() {
                    return telephone;
                }
                 ...
                 *     
                 */
                public void setTelephone(GetCarPNR.OTAReadRQ.ReadRequests.AirReadRequest.Telephone value) {
                 ...
                 * @return
                 *     possible object is
                 *     {@link GetCarPNR.OTAReadRQ.ReadRequests.AirReadRequest.CustLoyalty }
                 *     
                 */
                public GetCarPNR.OTAReadRQ.ReadRequests.AirReadRequest.CustLoyalty getCustLoyalty() {
                    return custLoyalty;
                }
                 ...
                 *     
                 */
                public void setCustLoyalty(GetCarPNR.OTAReadRQ.ReadRequests.AirReadRequest.CustLoyalty value) {
                 ...
                 * @return
                 *     possible object is
                 *     {@link GetCarPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo }
                 *     
                 */
                public GetCarPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo getQueueInfo() {
                    return queueInfo;
                }
                 ...
                 *     
                 */
                public void setQueueInfo(GetCarPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo value) {
                ...
                public static class QueueInfo {
                    ...
                    protected List<GetCarPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo.Queue> queue;
                     ...
                     * <p>
                     * Objects of the following type(s) are allowed in the list
                     * {@link GetCarPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo.Queue }
                     * 
                     * 
                     */
                    public List<GetCarPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo.Queue> getQueue() {
                        if (queue == null) {
                            queue = new ArrayList<GetCarPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo.Queue>();
                        }
                        return this.queue;
                    }
            ...
            public static class CruiseReadRequest {
                ...
                protected GetCarPNR.OTAReadRQ.ReadRequests.CruiseReadRequest.SelectedSailing selectedSailing;
                 ...
                 * @return
                 *     possible object is
                 *     {@link GetCarPNR.OTAReadRQ.ReadRequests.CruiseReadRequest.SelectedSailing }
                 *     
                 */
                public GetCarPNR.OTAReadRQ.ReadRequests.CruiseReadRequest.SelectedSailing getSelectedSailing() {
                 ...
                 *     
                 */
                public void setSelectedSailing(GetCarPNR.OTAReadRQ.ReadRequests.CruiseReadRequest.SelectedSailing value) {
            ...
            public static class GolfReadRequest {
                ...
                protected List<GetCarPNR.OTAReadRQ.ReadRequests.GolfReadRequest.Membership> membership;
                @XmlElement(name = "Name")
                protected PersonNameType name;
                 ...
                 * <p>
                 * Objects of the following type(s) are allowed in the list
                 * {@link GetCarPNR.OTAReadRQ.ReadRequests.GolfReadRequest.Membership }
                 * 
                 * 
                 */
                public List<GetCarPNR.OTAReadRQ.ReadRequests.GolfReadRequest.Membership> getMembership() {
                    if (membership == null) {
                        membership = new ArrayList<GetCarPNR.OTAReadRQ.ReadRequests.GolfReadRequest.Membership>();
                    }
            ...
            public static class HotelReadRequest {
                ...
                protected GetCarPNR.OTAReadRQ.ReadRequests.HotelReadRequest.Airport airport;
                @XmlElement(name = "UserID")
                protected GetCarPNR.OTAReadRQ.ReadRequests.HotelReadRequest.UserID userID;
                 ...
                 * @return
                 *     possible object is
                 *     {@link GetCarPNR.OTAReadRQ.ReadRequests.HotelReadRequest.Airport }
                 *     
                 */
                public GetCarPNR.OTAReadRQ.ReadRequests.HotelReadRequest.Airport getAirport() {
                    return airport;
                }
                 ...
                 *     
                 */
                public void setAirport(GetCarPNR.OTAReadRQ.ReadRequests.HotelReadRequest.Airport value) {
                    this.airport = value;
                }
                 ...
                 * @return
                 *     possible object is
                 *     {@link GetCarPNR.OTAReadRQ.ReadRequests.HotelReadRequest.UserID }
                 *     
                 */
                public GetCarPNR.OTAReadRQ.ReadRequests.HotelReadRequest.UserID getUserID() {
                    return userID;
                }
                 ...
                 *     
                 */
                public void setUserID(GetCarPNR.OTAReadRQ.ReadRequests.HotelReadRequest.UserID value) {
                    this.userID = value;
                }
