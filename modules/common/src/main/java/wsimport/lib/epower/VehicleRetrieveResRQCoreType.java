...
@XmlSeeAlso({
    wsimport.lib.epower.GetHotelPNR.OTAReadRQ.ReadRequests.VehicleReadRequest.class,
    wsimport.lib.epower.GetBasketPNR.OTAReadRQ.ReadRequests.VehicleReadRequest.class,
    wsimport.lib.epower.GetCarPNR.OTAReadRQ.ReadRequests.VehicleReadRequest.class,
    wsimport.lib.epower.GetPNR.OTAReadRQ.ReadRequests.VehicleReadRequest.class
})
