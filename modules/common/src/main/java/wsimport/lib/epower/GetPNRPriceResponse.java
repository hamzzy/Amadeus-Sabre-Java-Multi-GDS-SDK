...
@XmlRootElement(name = "GetPNRPriceResponse")
public class GetPNRPriceResponse {

    @XmlElement(name = "OTA_AirBookRS")
    protected GetPNRPriceResponse.OTAAirBookRS otaAirBookRS;
     ...
     * @return
     *     possible object is
     *     {@link GetPNRPriceResponse.OTAAirBookRS }
     *     
     */
    public GetPNRPriceResponse.OTAAirBookRS getOTAAirBookRS() {
        return otaAirBookRS;
    }
     ...
     *     
     */
    public void setOTAAirBookRS(GetPNRPriceResponse.OTAAirBookRS value) {
    ...
    public static class OTAAirBookRS {
        ...
        protected GetPNRPriceResponse.OTAAirBookRS.AirReservation airReservation;
        @XmlElements({
         ...
         * @return
         *     possible object is
         *     {@link GetPNRPriceResponse.OTAAirBookRS.AirReservation }
         *     
         */
        public GetPNRPriceResponse.OTAAirBookRS.AirReservation getAirReservation() {
         ...
         *     
         */
        public void setAirReservation(GetPNRPriceResponse.OTAAirBookRS.AirReservation value) {
