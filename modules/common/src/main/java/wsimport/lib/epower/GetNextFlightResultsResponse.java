...
@XmlRootElement(name = "GetNextFlightResultsResponse")
public class GetNextFlightResultsResponse {

    @XmlElement(name = "OTA_AirLowFareSearchRS")
    protected GetNextFlightResultsResponse.OTAAirLowFareSearchRS otaAirLowFareSearchRS;
     ...
     * @return
     *     possible object is
     *     {@link GetNextFlightResultsResponse.OTAAirLowFareSearchRS }
     *     
     */
    public GetNextFlightResultsResponse.OTAAirLowFareSearchRS getOTAAirLowFareSearchRS() {
     ...
     *     
     */
    public void setOTAAirLowFareSearchRS(GetNextFlightResultsResponse.OTAAirLowFareSearchRS value) {
