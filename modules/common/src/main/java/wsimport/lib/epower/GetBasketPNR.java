...
@XmlRootElement(name = "GetBasketPNR")
public class GetBasketPNR {

    @XmlElement(name = "OTA_ReadRQ")
    protected GetBasketPNR.OTAReadRQ otaReadRQ;
     ...
     * @return
     *     possible object is
     *     {@link GetBasketPNR.OTAReadRQ }
     *     
     */
    public GetBasketPNR.OTAReadRQ getOTAReadRQ() {
        return otaReadRQ;
    }
     ...
     *     
     */
    public void setOTAReadRQ(GetBasketPNR.OTAReadRQ value) {
    ...
    public static class OTAReadRQ {
        ...
        protected GetBasketPNR.OTAReadRQ.ReadRequests readRequests;
         ...
         * @return
         *     possible object is
         *     {@link GetBasketPNR.OTAReadRQ.ReadRequests }
         *     
         */
        public GetBasketPNR.OTAReadRQ.ReadRequests getReadRequests() {
            return readRequests;
        }
         ...
         *     
         */
        public void setReadRequests(GetBasketPNR.OTAReadRQ.ReadRequests value) {
        ...
        public static class ReadRequests {
            ...
            @XmlElements({
                @XmlElement(name = "HotelReadRequest", type = GetBasketPNR.OTAReadRQ.ReadRequests.HotelReadRequest.class),
                @XmlElement(name = "VehicleReadRequest", type = GetBasketPNR.OTAReadRQ.ReadRequests.VehicleReadRequest.class),
                @XmlElement(name = "AirReadRequest", type = GetBasketPNR.OTAReadRQ.ReadRequests.AirReadRequest.class),
                @XmlElement(name = "GolfReadRequest", type = GetBasketPNR.OTAReadRQ.ReadRequests.GolfReadRequest.class),
                @XmlElement(name = "PkgReadRequest", type = GetBasketPNR.OTAReadRQ.ReadRequests.PkgReadRequest.class),
                @XmlElement(name = "ReadRequest", type = GetBasketPNR.OTAReadRQ.ReadRequests.ReadRequest.class),
                @XmlElement(name = "CruiseReadRequest", type = GetBasketPNR.OTAReadRQ.ReadRequests.CruiseReadRequest.class),
                @XmlElement(name = "GlobalReservationReadRequest", type = GetBasketPNR.OTAReadRQ.ReadRequests.GlobalReservationReadRequest.class)
            })
             ...
             * {@link GetBasketPNR.OTAReadRQ.ReadRequests.HotelReadRequest }
             * {@link GetBasketPNR.OTAReadRQ.ReadRequests.VehicleReadRequest }
             * {@link GetBasketPNR.OTAReadRQ.ReadRequests.AirReadRequest }
             * {@link GetBasketPNR.OTAReadRQ.ReadRequests.GolfReadRequest }
             * {@link GetBasketPNR.OTAReadRQ.ReadRequests.PkgReadRequest }
             * {@link GetBasketPNR.OTAReadRQ.ReadRequests.ReadRequest }
             * {@link GetBasketPNR.OTAReadRQ.ReadRequests.CruiseReadRequest }
             * {@link GetBasketPNR.OTAReadRQ.ReadRequests.GlobalReservationReadRequest }
             * 
             * 
             */
            ...
            public static class AirReadRequest {
                ...
                protected GetBasketPNR.OTAReadRQ.ReadRequests.AirReadRequest.Telephone telephone;
                @XmlElement(name = "CustLoyalty")
                protected GetBasketPNR.OTAReadRQ.ReadRequests.AirReadRequest.CustLoyalty custLoyalty;
                ...
                protected GetBasketPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo queueInfo;
                 ...
                 * @return
                 *     possible object is
                 *     {@link GetBasketPNR.OTAReadRQ.ReadRequests.AirReadRequest.Telephone }
                 *     
                 */
                public GetBasketPNR.OTAReadRQ.ReadRequests.AirReadRequest.Telephone getTelephone() {
                    return telephone;
                }
                 ...
                 *     
                 */
                public void setTelephone(GetBasketPNR.OTAReadRQ.ReadRequests.AirReadRequest.Telephone value) {
                 ...
                 * @return
                 *     possible object is
                 *     {@link GetBasketPNR.OTAReadRQ.ReadRequests.AirReadRequest.CustLoyalty }
                 *     
                 */
                public GetBasketPNR.OTAReadRQ.ReadRequests.AirReadRequest.CustLoyalty getCustLoyalty() {
                    return custLoyalty;
                }
                 ...
                 *     
                 */
                public void setCustLoyalty(GetBasketPNR.OTAReadRQ.ReadRequests.AirReadRequest.CustLoyalty value) {
                 ...
                 * @return
                 *     possible object is
                 *     {@link GetBasketPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo }
                 *     
                 */
                public GetBasketPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo getQueueInfo() {
                    return queueInfo;
                }
                 ...
                 *     
                 */
                public void setQueueInfo(GetBasketPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo value) {
                ...
                public static class QueueInfo {
                    ...
                    protected List<GetBasketPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo.Queue> queue;
                     ...
                     * <p>
                     * Objects of the following type(s) are allowed in the list
                     * {@link GetBasketPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo.Queue }
                     * 
                     * 
                     */
                    public List<GetBasketPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo.Queue> getQueue() {
                        if (queue == null) {
                            queue = new ArrayList<GetBasketPNR.OTAReadRQ.ReadRequests.AirReadRequest.QueueInfo.Queue>();
                        }
                        return this.queue;
                    }
            ...
            public static class CruiseReadRequest {
                ...
                protected GetBasketPNR.OTAReadRQ.ReadRequests.CruiseReadRequest.SelectedSailing selectedSailing;
                 ...
                 * @return
                 *     possible object is
                 *     {@link GetBasketPNR.OTAReadRQ.ReadRequests.CruiseReadRequest.SelectedSailing }
                 *     
                 */
                public GetBasketPNR.OTAReadRQ.ReadRequests.CruiseReadRequest.SelectedSailing getSelectedSailing() {
                 ...
                 *     
                 */
                public void setSelectedSailing(GetBasketPNR.OTAReadRQ.ReadRequests.CruiseReadRequest.SelectedSailing value) {
            ...
            public static class GolfReadRequest {
                ...
                protected List<GetBasketPNR.OTAReadRQ.ReadRequests.GolfReadRequest.Membership> membership;
                @XmlElement(name = "Name")
                protected PersonNameType name;
                 ...
                 * <p>
                 * Objects of the following type(s) are allowed in the list
                 * {@link GetBasketPNR.OTAReadRQ.ReadRequests.GolfReadRequest.Membership }
                 * 
                 * 
                 */
                public List<GetBasketPNR.OTAReadRQ.ReadRequests.GolfReadRequest.Membership> getMembership() {
                    if (membership == null) {
                        membership = new ArrayList<GetBasketPNR.OTAReadRQ.ReadRequests.GolfReadRequest.Membership>();
                    }
            ...
            public static class HotelReadRequest {
                ...
                protected GetBasketPNR.OTAReadRQ.ReadRequests.HotelReadRequest.Airport airport;
                @XmlElement(name = "UserID")
                protected GetBasketPNR.OTAReadRQ.ReadRequests.HotelReadRequest.UserID userID;
                 ...
                 * @return
                 *     possible object is
                 *     {@link GetBasketPNR.OTAReadRQ.ReadRequests.HotelReadRequest.Airport }
                 *     
                 */
                public GetBasketPNR.OTAReadRQ.ReadRequests.HotelReadRequest.Airport getAirport() {
                    return airport;
                }
                 ...
                 *     
                 */
                public void setAirport(GetBasketPNR.OTAReadRQ.ReadRequests.HotelReadRequest.Airport value) {
                    this.airport = value;
                }
                 ...
                 * @return
                 *     possible object is
                 *     {@link GetBasketPNR.OTAReadRQ.ReadRequests.HotelReadRequest.UserID }
                 *     
                 */
                public GetBasketPNR.OTAReadRQ.ReadRequests.HotelReadRequest.UserID getUserID() {
                    return userID;
                }
                 ...
                 *     
                 */
                public void setUserID(GetBasketPNR.OTAReadRQ.ReadRequests.HotelReadRequest.UserID value) {
                    this.userID = value;
                }
