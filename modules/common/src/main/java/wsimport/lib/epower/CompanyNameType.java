 ...
 *       &lt;attribute name="TermsAndConditions" type="{http://www.w3.org/2001/XMLSchema}string" />
...
@XmlSeeAlso({
    ...
    wsimport.lib.epower.DirectBillType.CompanyName.class,
    wsimport.lib.epower.AllianceConsortiumType.AllianceMember.class,
    TravelArrangerType.class,
    CompanyNamePrefType.class,
    wsimport.lib.epower.FlightSegmentType.MarketingAirline.class,
    VehicleAvailCoreTypeVendor.class
})
