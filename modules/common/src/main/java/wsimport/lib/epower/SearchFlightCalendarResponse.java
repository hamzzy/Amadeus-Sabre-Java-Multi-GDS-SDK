...
@XmlRootElement(name = "SearchFlightCalendarResponse")
public class SearchFlightCalendarResponse {

    @XmlElement(name = "OTA_AirLowFareSearchRS")
    protected SearchFlightCalendarResponse.OTAAirLowFareSearchRS otaAirLowFareSearchRS;
     ...
     * @return
     *     possible object is
     *     {@link SearchFlightCalendarResponse.OTAAirLowFareSearchRS }
     *
     */
    public SearchFlightCalendarResponse.OTAAirLowFareSearchRS getOTAAirLowFareSearchRS() {
     ...
     *
     */
    public void setOTAAirLowFareSearchRS(SearchFlightCalendarResponse.OTAAirLowFareSearchRS value) {
