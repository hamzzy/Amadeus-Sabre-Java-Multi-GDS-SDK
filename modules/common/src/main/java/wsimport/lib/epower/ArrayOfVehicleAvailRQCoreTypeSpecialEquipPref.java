 ...
 *       &lt;sequence>
 *         &lt;element name="SpecialEquipPref" type="{http://epowerv5.amadeus.com.tr/WS}VehicleAvailRQCoreTypeSpecialEquipPref" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfVehicleAvailRQCoreTypeSpecialEquipPref {
    ...
    protected List<VehicleAvailRQCoreTypeSpecialEquipPref> specialEquipPref;
     ...
     * {@link VehicleAvailRQCoreTypeSpecialEquipPref }
     * 
     * 
     */
    public List<VehicleAvailRQCoreTypeSpecialEquipPref> getSpecialEquipPref() {
        if (specialEquipPref == null) {
            specialEquipPref = new ArrayList<VehicleAvailRQCoreTypeSpecialEquipPref>();
        }
