...
@XmlSeeAlso({
    wsimport.lib.epower.TravelClubType.ClubMemberName.class,
    CoveredTravelerTypeCoveredPerson.class,
    wsimport.lib.epower.OrganizationType.OrgMemberName.class,
    wsimport.lib.epower.VerificationType.PersonName.class,
    CoveredTravelerTypeBeneficiaryName.class
})
