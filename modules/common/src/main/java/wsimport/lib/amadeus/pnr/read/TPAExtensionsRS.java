 ...
 *           &lt;element name="Rules" type="{http://traveltalk.com/wsPNRRead}ArrayOfString" minOccurs="0"/>
 ...
 *           &lt;element name="CarOptions" type="{http://traveltalk.com/wsPNRRead}ArrayOfCarOption" minOccurs="0"/>
 ...
 *           &lt;element name="AgencyCommission" type="{http://traveltalk.com/wsPNRRead}AgencyCommission" minOccurs="0"/>
 ...
 *           &lt;element name="AgencyServiceFee" type="{http://traveltalk.com/wsPNRRead}AgencyServiceFee" minOccurs="0"/>
 *         &lt;/choice>
 ...
 *         &lt;element name="IssuedTickets" type="{http://traveltalk.com/wsPNRRead}IssuedTickets" minOccurs="0"/>
 ...
 *         &lt;element name="PaymentCard" type="{http://traveltalk.com/wsPNRRead}PaymentCardRS" minOccurs="0"/>
 *         &lt;element name="ValidatingAirlineCode" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="BagAllowance" type="{http://traveltalk.com/wsPNRRead}BagAllowance" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="FareRules" type="{http://traveltalk.com/wsPNRRead}FareRules" minOccurs="0"/>
 *         &lt;element name="OriginRailwayStation" type="{http://traveltalk.com/wsPNRRead}OriginRailwayStation" minOccurs="0"/>
 *         &lt;element name="DestinationRailwayStation" type="{http://traveltalk.com/wsPNRRead}DestinationRailwayStation" minOccurs="0"/>
 *         &lt;element name="AccountingInfo" type="{http://traveltalk.com/wsPNRRead}AccountingInfo" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="FuturePriceInfo" type="{http://traveltalk.com/wsPNRRead}FuturePriceInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class TPAExtensionsRS {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "RollawayAdult", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "FareRules", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "GuestFirstName", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Arnk", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Crib", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "BagAllowance", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "CorporateDiscount", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "OverrideCorporateRate", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "SupplementalInfo", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "MealPlan", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "OriginCityCode", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "FuturePriceInfo", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "TourNumber", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "OriginRailwayStation", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ValidatingAirlineCode", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "CarType", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Rules", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "AccountingLine", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Vendor", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "RateQuoted", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "RoomLocation", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "AlternateCurrency", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "RateRequested", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "FareCalculation", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "AccountingInfo", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "RollawayChild", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "IssuedTickets", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "AgencyCommission", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "GuestLastName", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "MerchantCurrency", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "DestinationRailwayStation", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "AdvancedDeposit", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "PaymentRestrictions", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ExtraChild", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "PaymentCard", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "CarOptions", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "AgencyServiceFee", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ExtraAdult", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false)
    })
    @XmlMixed
