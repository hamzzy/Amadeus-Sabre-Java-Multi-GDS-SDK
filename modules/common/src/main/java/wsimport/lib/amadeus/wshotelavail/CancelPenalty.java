 ...
 *         &lt;element name="PenaltyDescription" type="{http://traveltalk.com/wsHotelAvail}PenaltyDescription" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class CancelPenalty {
    ...
    protected List<PenaltyDescription> penaltyDescription;
     ...
     * {@link PenaltyDescription }
     * 
     * 
     */
    public List<PenaltyDescription> getPenaltyDescription() {
        if (penaltyDescription == null) {
            penaltyDescription = new ArrayList<PenaltyDescription>();
        }
