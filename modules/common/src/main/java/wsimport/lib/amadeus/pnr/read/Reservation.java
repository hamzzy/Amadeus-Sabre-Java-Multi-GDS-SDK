 ...
 *       &lt;sequence>
 *         &lt;element name="RoomTypes" type="{http://traveltalk.com/wsPNRRead}RoomTypesRS" minOccurs="0"/>
 *         &lt;element name="RatePlans" type="{http://traveltalk.com/wsPNRRead}ArrayOfRatePlan" minOccurs="0"/>
 *         &lt;element name="RoomRates" type="{http://traveltalk.com/wsPNRRead}RoomRatesRS" minOccurs="0"/>
 *         &lt;element name="GuestCounts" type="{http://traveltalk.com/wsPNRRead}GuestCountsRS" minOccurs="0"/>
 *         &lt;element name="TimeSpan" type="{http://traveltalk.com/wsPNRRead}TimeSpanRS" minOccurs="0"/>
 *         &lt;element name="Guarantee" type="{http://traveltalk.com/wsPNRRead}GuaranteeRS" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="DepositPayment" type="{http://traveltalk.com/wsPNRRead}DepositPaymentRS" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="BasicPropertyInfo" type="{http://traveltalk.com/wsPNRRead}BasicPropertyInfoRS" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
