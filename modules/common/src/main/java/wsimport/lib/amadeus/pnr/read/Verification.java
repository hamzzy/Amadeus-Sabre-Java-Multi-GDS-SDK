 ...
 *         &lt;element name="Email" type="{http://traveltalk.com/wsPNRRead}Email" minOccurs="0"/>
 *         &lt;element name="TelephoneInfo" type="{http://traveltalk.com/wsPNRRead}TelephoneInfo" minOccurs="0"/>
 *         &lt;element name="PaymentCard" type="{http://traveltalk.com/wsPNRRead}PaymentCard" minOccurs="0"/>
 *         &lt;element name="AddressInfo" type="{http://traveltalk.com/wsPNRRead}AddressInfo" minOccurs="0"/>
 *         &lt;element name="CustLoyalty" type="{http://traveltalk.com/wsPNRRead}CustLoyalty" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Vendor" type="{http://traveltalk.com/wsPNRRead}VendorRQ" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="ReservationTimeSpan" type="{http://traveltalk.com/wsPNRRead}ReservationTimeSpan" minOccurs="0"/>
 *         &lt;element name="AssociatedQuantity" type="{http://traveltalk.com/wsPNRRead}AssociatedQuantity" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="StartLocation" type="{http://traveltalk.com/wsPNRRead}StartLocation" minOccurs="0"/>
 *         &lt;element name="EndLocation" type="{http://traveltalk.com/wsPNRRead}EndLocation" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Verification {
    ...
    protected List<VendorRQ> vendor;
     ...
     * 
     */
    public List<VendorRQ> getVendor() {
        if (vendor == null) {
            vendor = new ArrayList<VendorRQ>();
        }
        return this.vendor;
    }
