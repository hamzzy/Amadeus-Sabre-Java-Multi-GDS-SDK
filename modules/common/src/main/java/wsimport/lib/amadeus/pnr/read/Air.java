 ...
 *           &lt;element name="Seats" type="{http://traveltalk.com/wsPNRRead}ArrayOfSeat" minOccurs="0"/>
 *           &lt;element name="Equipment" type="{http://traveltalk.com/wsPNRRead}Equipment" minOccurs="0"/>
 *           &lt;element name="MarriageGrp" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *           &lt;element name="OperatingAirline" type="{http://traveltalk.com/wsPNRRead}OperatingAirline" minOccurs="0"/>
 ...
 *           &lt;element name="MarketingAirline" type="{http://traveltalk.com/wsPNRRead}MarketingAirline" minOccurs="0"/>
 *           &lt;element name="ArrivalAirport" type="{http://traveltalk.com/wsPNRRead}ArrivalAirport" minOccurs="0"/>
 *         &lt;/choice>
 *       &lt;/sequence>
 ...
 *       &lt;attribute name="E_TicketEligibility" type="{http://traveltalk.com/wsPNRRead}E_TicketEligibilityType" />
 *       &lt;attribute name="MealCode" type="{http://www.w3.org/2001/XMLSchema}string" />
 *       &lt;attribute name="DepartureDay" type="{http://traveltalk.com/wsPNRRead}DepartureDayType" />
 *       &lt;attribute name="OrginDestType" type="{http://traveltalk.com/wsPNRRead}AirOrginDestType" />
 *       &lt;attribute name="CouponStatus" type="{http://traveltalk.com/wsPNRRead}CouponStatus" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class Air {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "TPA_Extensions", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "DepartureAirport", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "MarriageGrp", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Equipment", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Seats", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "MarketingAirline", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "ArrivalAirport", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "OperatingAirline", namespace = "http://traveltalk.com/wsPNRRead", type = JAXBElement.class, required = false)
    })
    @XmlMixed
