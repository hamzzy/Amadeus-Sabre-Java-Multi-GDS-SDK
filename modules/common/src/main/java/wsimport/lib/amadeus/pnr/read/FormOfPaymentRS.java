 ...
 *         &lt;element name="BankAcct" type="{http://traveltalk.com/wsPNRRead}BankAcct" minOccurs="0"/>
 *         &lt;element name="DirectBill" type="{http://traveltalk.com/wsPNRRead}DirectBillRS" minOccurs="0"/>
 *         &lt;element name="Voucher" type="{http://traveltalk.com/wsPNRRead}VoucherRS" minOccurs="0"/>
 *         &lt;element name="LoyaltyRedemption" type="{http://traveltalk.com/wsPNRRead}LoyaltyRedemptionRS" minOccurs="0"/>
 *         &lt;element name="MiscChargeOrder" type="{http://traveltalk.com/wsPNRRead}MiscChargeOrderRS" minOccurs="0"/>
 *         &lt;element name="TPA_Extensions" type="{http://traveltalk.com/wsPNRRead}TPA_ExtensionsRS" minOccurs="0"/>
 *         &lt;element name="PaymentAmount" type="{http://traveltalk.com/wsPNRRead}PaymentAmountRS" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attribute name="ShareSynchInd" type="{http://traveltalk.com/wsPNRRead}FormOfPaymentShareSynchInd" />
 *       &lt;attribute name="ShareMarketInd" type="{http://traveltalk.com/wsPNRRead}FormOfPaymentShareMarketInd" />
